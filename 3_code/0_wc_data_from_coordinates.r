...
#
# Aitor Vázquez Veloso, 29/04/2024
#--------------------------------------#
...
source('WorldClim/scripts/wc_future_MIROC6_data.R')
...
plots <- merge(plots, m_fut_by_period, by.x = 'ID', by.y = 'ID')
...
# Save results ====
save.image('1_data/1_raw/plot_climate_data_all.RData')
